...
public class InterProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox_iva.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione Itebis:", "Sin Itebis", "18%" }));
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        ...
        if (txt_nombre.getText().equals("") || txt_cantidad.getText().equals("") || txt_precio.getText().equals("")) {
            ...
            if (!controlProducto.existeProducto(txt_nombre.getText().trim())) {
                if (iva.equalsIgnoreCase("Seleccione Itebis:")) {
                    JOptionPane.showMessageDialog(null, "Seleccione Itebis.");
                } else {
                    if (categoria.equalsIgnoreCase("Seleccione categoria:")) {
                        ...
                        try {
                            ...
                            *Si el usuario ingresa , (coma) como punto decimal,
                            ...
                            //Porcentaje IVA
                            if (iva.equalsIgnoreCase("Sin Itebis")) {
                            ...
                            if (controlProducto.guardar(producto)) {
                                ...
                                this.CargarComboCategorias();
                                this.jComboBox_iva.setSelectedItem("Seleccione Itebis:");
                                this.Limpiar();
                            } else {
